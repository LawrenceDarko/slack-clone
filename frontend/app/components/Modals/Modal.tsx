            ...
            <div className="w-[448px] bg-white rounded-md p-8">
                ...
                <div className="mb-4">
                    ...
                    <div className="flex items-center mt-2">
                        ...
                        />
                        <label htmlFor="public" className="text-gray-800">Public - anyone in New Workspace</label>
                    </div>
                    <div className="flex items-center mt-2">
                        <input
                            type="radio"
                        ...
                        />
                        <label htmlFor="private" className="text-gray-800">Private - Only specific people</label>
                    </div>
                </div>
                ...
                <div className="flex justify-between">
                    <div className="flex items-center">
                        ...
                        <label htmlFor="inviteExternal" className="text-gray-800">Invite external people</label>
                    </div>
